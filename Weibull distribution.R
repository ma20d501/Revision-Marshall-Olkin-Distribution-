...
# Set the parameters for the bivariate Weibull distribution
...
shape1 <- 2  # Shape parameter for variable 1
scale1 <- 4  # Scale parameter for variable 1
shape2 <- 3  # Shape parameter for variable 2
scale2 <- 2.5  # Scale parameter for variable 2

# Generate random samples from the Weibull distribution for each variable
x <- rweibull(n, shape = shape1, scale = scale1)
y <- rweibull(n, shape = shape2, scale = scale2)

bivariate_data<- cbind(x,y)
######## Generated Random samples from bivariate exponential distribution #############
print(x)
print(y)
############Test statistics####################
